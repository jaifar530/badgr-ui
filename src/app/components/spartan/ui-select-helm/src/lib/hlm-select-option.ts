...
@Component({
	...
	template: `
		<span class="tw-absolute tw-end-2 tw-flex tw-size-3.5 tw-items-center tw-justify-center">
...
export class HlmSelectOption {
	...
	protected readonly _computedClass = computed(() =>
		hlm(
			...
			'tw-relative tw-flex tw-w-full tw-cursor-default tw-select-none tw-items-center tw-rounded-sm tw-py-1.5 tw-ps-8 tw-pe-2 tw-text-sm tw-outline-none data-[active]:tw-bg-accent data-[active]:tw-text-accent-foreground data-[disabled]:tw-pointer-events-none data-[disabled]:tw-opacity-50',
			this.userClass(),
		),
	);
}
