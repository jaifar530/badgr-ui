...
@Component({
	...
	providers: [
		provideHlmTableConfig({
			...
			th: 'tw-px-2 first:tw-ps-4 last:tw-pe-4 tw-py-4 tw-leading-8 tw-border-b tw-border-solid tw-border-purple tw-align-middle',
			td: 'tw-px-2 first:tw-ps-4 last:tw-pe-4 tw-py-4 tw-leading-7 tw-border-b tw-border-solid tw-border-purple tw-align-middle',
		}),
	],
	host: {
